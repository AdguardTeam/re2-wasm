...
The directory `third_party/node-re2/` is a copy of [node-re2](https://github.com/uhop/node-re2),
keeping only the `tests` folder. Those tests were modified to test this library as follows:
